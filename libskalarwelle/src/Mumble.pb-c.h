...
typedef struct _MumbleProto__ContextActionModify
...
typedef struct _MumbleProto__VoiceTarget__Target
...
typedef enum _MumbleProto__PermissionDenied__DenyType
{
  ...
  MUMBLE_PROTO__PERMISSION_DENIED__DENY_TYPE__NestingLimit = 10
    ...
    (MUMBLE_PROTO__PERMISSION_DENIED__DENY_TYPE)
...
typedef enum _MumbleProto__ContextActionModify__Context
{
  ...
  MUMBLE_PROTO__CONTEXT_ACTION_MODIFY__CONTEXT__User = 4
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE
    (MUMBLE_PROTO__CONTEXT_ACTION_MODIFY__CONTEXT)
...
typedef enum _MumbleProto__ContextActionModify__Operation
{
  ...
  MUMBLE_PROTO__CONTEXT_ACTION_MODIFY__OPERATION__Remove = 1
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE
    (MUMBLE_PROTO__CONTEXT_ACTION_MODIFY__OPERATION)
...
typedef void (*MumbleProto__Version_Closure)
  (const MumbleProto__Version * message, void *closure_data);
typedef void (*MumbleProto__UDPTunnel_Closure)
  (const MumbleProto__UDPTunnel * message, void *closure_data);
typedef void (*MumbleProto__Authenticate_Closure)
  (const MumbleProto__Authenticate * message, void *closure_data);
typedef void (*MumbleProto__Ping_Closure)
  (const MumbleProto__Ping * message, void *closure_data);
typedef void (*MumbleProto__Reject_Closure)
  (const MumbleProto__Reject * message, void *closure_data);
typedef void (*MumbleProto__ServerSync_Closure)
  (const MumbleProto__ServerSync * message, void *closure_data);
typedef void (*MumbleProto__ChannelRemove_Closure)
  (const MumbleProto__ChannelRemove * message, void *closure_data);
typedef void (*MumbleProto__ChannelState_Closure)
  (const MumbleProto__ChannelState * message, void *closure_data);
typedef void (*MumbleProto__UserRemove_Closure)
  (const MumbleProto__UserRemove * message, void *closure_data);
typedef void (*MumbleProto__UserState_Closure)
  (const MumbleProto__UserState * message, void *closure_data);
typedef void (*MumbleProto__BanList__BanEntry_Closure)
  (const MumbleProto__BanList__BanEntry * message, void *closure_data);
typedef void (*MumbleProto__BanList_Closure)
  (const MumbleProto__BanList * message, void *closure_data);
typedef void (*MumbleProto__TextMessage_Closure)
  (const MumbleProto__TextMessage * message, void *closure_data);
typedef void (*MumbleProto__PermissionDenied_Closure)
  (const MumbleProto__PermissionDenied * message, void *closure_data);
typedef void (*MumbleProto__ACL__ChanGroup_Closure)
  (const MumbleProto__ACL__ChanGroup * message, void *closure_data);
typedef void (*MumbleProto__ACL__ChanACL_Closure)
  (const MumbleProto__ACL__ChanACL * message, void *closure_data);
typedef void (*MumbleProto__ACL_Closure)
  (const MumbleProto__ACL * message, void *closure_data);
typedef void (*MumbleProto__QueryUsers_Closure)
  (const MumbleProto__QueryUsers * message, void *closure_data);
typedef void (*MumbleProto__CryptSetup_Closure)
  (const MumbleProto__CryptSetup * message, void *closure_data);
typedef void (*MumbleProto__ContextActionModify_Closure)
  (const MumbleProto__ContextActionModify * message, void *closure_data);
typedef void (*MumbleProto__ContextAction_Closure)
  (const MumbleProto__ContextAction * message, void *closure_data);
typedef void (*MumbleProto__UserList__User_Closure)
  (const MumbleProto__UserList__User * message, void *closure_data);
typedef void (*MumbleProto__UserList_Closure)
  (const MumbleProto__UserList * message, void *closure_data);
typedef void (*MumbleProto__VoiceTarget__Target_Closure)
  (const MumbleProto__VoiceTarget__Target * message, void *closure_data);
typedef void (*MumbleProto__VoiceTarget_Closure)
  (const MumbleProto__VoiceTarget * message, void *closure_data);
typedef void (*MumbleProto__PermissionQuery_Closure)
  (const MumbleProto__PermissionQuery * message, void *closure_data);
typedef void (*MumbleProto__CodecVersion_Closure)
  (const MumbleProto__CodecVersion * message, void *closure_data);
typedef void (*MumbleProto__UserStats__Stats_Closure)
  (const MumbleProto__UserStats__Stats * message, void *closure_data);
typedef void (*MumbleProto__UserStats_Closure)
  (const MumbleProto__UserStats * message, void *closure_data);
typedef void (*MumbleProto__RequestBlob_Closure)
  (const MumbleProto__RequestBlob * message, void *closure_data);
typedef void (*MumbleProto__ServerConfig_Closure)
  (const MumbleProto__ServerConfig * message, void *closure_data);
typedef void (*MumbleProto__SuggestConfig_Closure)
  (const MumbleProto__SuggestConfig * message, void *closure_data);
